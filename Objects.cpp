...
GLfloat light2_position_c[4] = {   0.0f, 100.0f,  100.0f, 1.0f };
    ...
    switch (tipo) {
        ...
        case COCHE_ID: {
            ...
            if (escena.show_wheels)
            {
                ...
                // RUEDA trasera Dcha : Calculo de la matriz modelo
                ...
                modelMatrix     = glm::translate(modelMatrix, glm::vec3(2.5, 0, 0.8));
                modelMatrix     = glm::rotate(modelMatrix, (float) glm::radians(-ry), glm::vec3(0,1,0));
                modelMatrix     = glm::translate(modelMatrix, glm::vec3(-2.5, 0, -0.8));
...
void __fastcall TGui::Init(int main_window) {
    ...
    new GLUI_Checkbox( obj_panel, "Proyeccion paralela (on) o perspectiva (off)", &escena.perspectiva, 1, controlCallback);
